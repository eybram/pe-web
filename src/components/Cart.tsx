  ...
  return (
    <div className="fixed inset-0 bg-black/75 z-50 flex items-end md:items-center justify-center">
      <div className="bg-black border-4 border-[#FF5757] rounded-t-2xl md:rounded-2xl w-full md:w-96 max-h-screen md:max-h-[600px] flex flex-col">
        <div className="flex items-center justify-between p-6 border-b-2 border-[#FF5757]">
          <h2 className="text-2xl font-black text-[#FF5757] flex items-center gap-2">
        ...
        {items.length === 0 ? (
          ...
          <>
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {items.map((item) => (
                <div
                  ...
                  className="bg-gray-900 border border-[#FF5757]/50 rounded-lg p-4"
                >
                  <div className="flex gap-3 mb-3">
                    <img
                      src={item.product.image}
                      alt={item.product.name}
                      className="w-16 h-16 object-cover rounded border border-[#FF5757]"
                    />
                    <div className="flex-1">
                      ...
                      <p className="text-[#FF5757] font-bold mt-1">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="text-[#FF5757] hover:text-white transition font-bold"
                      >
                        −
                      </button>
                    ...
                    <button
                      ...
                      className="text-gray-500 hover:text-[#FF5757] transition"
                    >
            ...
            <div className="border-t-2 border-[#FF5757] p-4 space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-white font-bold">Subtotal:</span>
                <span className="text-[#FF5757] font-black text-lg">
                  ${total.toFixed(2)}
                </span>
              </div>
